...
import medu from "../images/medu_vada.jpeg"
...
const Vada = () => {
  ...
  return (
    <><div className='fixed bg-red-400  text-[40px] font-bold font-exquisite text-white text-center w-screen top-0 left-0 right-0 text-red-500 sm:text-[50px] '>Vada</div>
