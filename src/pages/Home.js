...
const Home = () => {
 ...
 <div className='bg-red-white '>
  ...
  <div className=' bg-gray-800 sm1:text-[40px] sm:text-[50px] font-exquisite font-bold shadow-md border border-black border-[2px]  fixed  text-white w-screen top-0 left-0 right-0'>DL'S Food Court</div>
