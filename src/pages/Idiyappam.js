...
const Idiyappam = () => {
  ...
  return (
    <><div className='fixed bg-red-400 text-center text-[40px] font-bold font-exquisite text-white w-screen top-0 left-0 right-0 text-red-500 sm:text-[50px] '>Idiyappam</div>
