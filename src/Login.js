...
const Login = () => {
  ...
  return (
    ...
    <div  className='my-[15px]'>
       ...
       <div> <input className="lg:h-[40px] rounded-[5px] " type="email" required  placeholder='email'  onChange={(e)=>setUserMail(e.target.value)} /></div>
       
    </div>
    <div  className='my-[15px]'>
        <div  className=' my-[10px]'> <label className='lg:text-[30px] font-montserrat text-[20px]'>Password</label></div>
       <div>  <input className=" lg:h-[40px] rounded-[5px]" type="password" required  placeholder="password"  onChange={(e)=>setUserPassword(e.target.value)}/></div>
